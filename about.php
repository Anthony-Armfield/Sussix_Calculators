    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <p>
            <a class="btn btn-primary" href="calcs.php">Calculators &raquo;</a>
          </p>
        </div>
        <div class="col-sm-6">
          ...
          <p>Click the button below to contact us today!</p>
            <a class="btn btn-primary" href="contact.php">Contact Us &raquo;</a>
          </p>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-sm-6 mailing-list" id="mailing-list">
          <form id="email_form" name="email_form" action="views/join.php" method="post">  <!-- send to join.php-->
            <div class="row">
              <div class="col-sm-4">
