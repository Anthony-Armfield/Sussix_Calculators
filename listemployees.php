...
try {
    ...
    echo 'PDOException: ' . $e='Unable to connect to database.';
} catch (Exception $e) {
        ...
        <?php foreach ($listEmployees as $employee) : ?>
            <div class="col-sm-3">
                <ul style="list-style: none;">
                        <li>
                            <?php echo $employee->getEmployeeFirstName() . ' ' . $employee->getEmployeeLastName(); ?> <br>
                            <?php echo 'ID: ' . $employee->getEmployeeID(); ?> <br>
